...
R6.1) Mettre le dossier toy_model_params dans le dossier input -> fait par CM
R6.2) Avoir les output du script toy_model dans un dossier toy_model dans output au lieu d'un sous dossier de long_term_uc
